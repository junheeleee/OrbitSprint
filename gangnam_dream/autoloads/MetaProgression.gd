...
func get_trait_bonus(trait: String) -> Dictionary:
	return data.get("trait_bonuses", {}).get(trait, {})

func unlock_trait(trait: String) -> void:
...
func is_hidden_event_unlocked(event_id: String) -> bool:
...
func _check_progression_unlocks(summary: Dictionary) -> void:
